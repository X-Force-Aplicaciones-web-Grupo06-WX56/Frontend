...
import Notifications from "@/public/components/notifications.component.vue";
import FeatureSection from "@/public/pages/FeatureSection.vue";
...
const routes = [
  ...
  { path: "/feature", component: FeatureSection, name: "feature" }  // Ruta para FeatureSection
];
